...
From the [preregistration document]() (p. 11):
...
Applied to the two preregistered lists of [RR articles]() and [PR articles](), this means that the following articles will be chosen:
...
print(RRlist[RRselection,"Title"])
